...
#SBATCH --job-name ALlocPAsminmac2
...
loc=concat
prefix=ALminmac2 #2 3

readarray -t VARS < $data/urbansamples.txt #missingvcf.txt #urbansamples.txt #$data/WCAurban.txt #urbansamples2 is the ones that failed the first time due to oom
