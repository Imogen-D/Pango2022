...
tab<-read.table(paste0(indv, ".", loc, ".bigscale.f1.bamhits"),header=F)
tab[,1]<-as.numeric(tab[,1])
head(tab)
...
hist1<-hist(tab2[,1],xlim=c(0,50),ylim=c(0,50000),breaks=seq(1,max(tab2[,1]),1),col="green",xlab="Coverage",main=indv) 
